...
public class TestLockManager {
  ...
  public void test9() throws InterruptedException {
    ...
    assertFalse("Transaction 1 Thread should have finished", thread3.isAlive()); //T1 should not be blocked

    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T1 should have shared lock
    ...
    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T1 should still have shared lock
    ...
    assertTrue("Transaction 3 blocked", thread3.isAlive()); //T1 Second thread should not be blocked

    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED));
    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T1 should now have exclusive lock
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.EXCLUSIVE)); //T2 still did not obtain exclusive lock
    assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T2 still did not obtain exclusive lock

    lockMan.releaseLock("A", 3); //Transaction 2 releasing its lock
    thread3.join(100);
    assertFalse("Transaction 3 not blocked", thread3.isAlive()); //T1 Second thread should not be blocked

    assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED));
    assertFalse(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T1 should now have exclusive lock
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.EXCLUSIVE)); //T2 still did not obtain exclusive lock
    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.EXCLUSIVE)); //T2 still did not obtain exclusive lock
  ...
  public void test8() throws InterruptedException {
    ...
    thread3.start();
    thread3.join(100); //waits for thread to finish (timeout of .1 sec)
    assertTrue("Transaction 1 Second Thread should have finished", thread3.isAlive()); //T1 Second thread should not be blocked
  ...
  @Test
  @Category(StudentTestP3.class)
  public void testFourShareTogether() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    assertTrue(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED)); //T1 should have shared lock
    assertTrue(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED)); //T2 should also have shared lock
    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T2 should also have shared lock
    ...
    assertTrue(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED)); //T2 should also have shared lock
    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T2 should also have shared lock
    assertTrue(lockMan.holdsLock("A", 4, LockManager.LockType.SHARED)); //T2 should also have shared lock
    ...
    assertFalse(lockMan.holdsLock("A", 3, LockManager.LockType.SHARED)); //T2 now does not have shared lock
    lockMan.releaseLock("A", 4); //Transaction 2 releasing its lock

    assertFalse(lockMan.holdsLock("A", 4, LockManager.LockType.SHARED)); //T2 now does not have shared lock
  }


  @Test
  @Category(StudentTestP3.class)
  public void testTwoShareOneWait() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    thread2.start();
    thread2.join(100);
    assertFalse("Transaction 2 Thread should have finished", thread2.isAlive()); //T1 should not be blocked
    ...
    thread3.start();
    thread3.join(100);
    assertTrue("Transaction 2 Thread should have finished", thread3.isAlive()); //T1 should not be blocked
  }

  @Test
  @Category(StudentTestP3.class)
  public void testTwoShareOneWaitThenRelease() throws InterruptedException {
    final LockManager lockMan = new LockManager();
    Thread thread1 = new Thread(new Runnable() {
      public void run() {
        /*Code to run goes inside here */
    ...
    assertFalse(lockMan.holdsLock("A", 2, LockManager.LockType.SHARED)); //T2 now does not have shared lock
    lockMan.releaseLock("A", 1); //Transaction 2 releasing its lock

    assertFalse(lockMan.holdsLock("A", 1, LockManager.LockType.SHARED)); //T2 now does not have shared lock

    thread3.join(100);
    assertFalse("Transaction 2 Thread should have finished", thread3.isAlive()); //T1 should not be blocked

    assertTrue(lockMan.holdsLock("A", 3, LockManager.LockType.EXCLUSIVE)); //T2 now does not have shared lock
  }
  ...
  public void test10() throws InterruptedException {
    ...
    thread2.start();
    thread2.join(100); //waits for thread to finish (timeout of .1 sec)
    assertFalse("Transaction 2 Thread should not have finished", thread2.isAlive()); //T2 should be waiting on T1
    ...
    assertTrue("Transaction 4 Thread should not have finished", thread5.isAlive()); //T4 should be waiting on T1
    ...
    lockMan.releaseLock("A", 2); //Transaction 1 releasing its lock
    lockMan.releaseLock("A", 3); //Transaction 1 releasing its lock

    thread4.join(100); //wait for thread 2 to finish
    thread5.join(100);
    assertFalse("Thread 5 should have finished", thread5.isAlive()); //T2 should not be blocked

    assertTrue("Thread 4 should not have finished", thread4.isAlive()); //T3 should not be blocked
